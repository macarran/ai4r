...
def slam(data, N, num_landmarks, motion_noise, measurement_noise):
    ...
    # Dimension is length of path N plus the number of landmarks. Multiply it by two, because we are on 2D now.
    ...
    for k in range(len(data)):
        # n is index of robot pose, remember we are in 2D now
        n = k * 2
